...
namespace Game
{
    ...
    В базу даних, створену у попередньому завданні (дані про лікарів) додати поле з зарплатнею лікарів. 
    Вивести на екран всіх лікарів, упорядкувавши їх згідно їх зарплатні у порядку спадання. 
    Вивести лікарів, зарлати яких меньше за середню зарплатню.
    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            using (var context = new UniversityContext())
            {
                ...
                var Doctors2 = context.Doctors.Include(s => s.specialization).Where(s => s.salary < context.Doctors.Average(s => s.salary)).ToList();
                Window2.WriteLine("Doctors where salary < avg salary:");
                Window2.Draw();
                Window2.WriteLine(string.Join("\n", Doctors2));
                Window2.Draw();
