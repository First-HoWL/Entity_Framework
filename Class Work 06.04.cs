...
namespace Game
{
    ...
    class Program
    {
        ...
        static void RemoveStudent(UniversityContext context)
        {
        ...
        static void Main(string[] args)
        {
            ...
            using (var context = new UniversityContext())
            {
                ...
                while (true)
                {
                    ...
                    var students = context.Students.Include(s => s.groupe).OrderBy(s => s.Id);
                    ...
                    var students1 = context.Students.Include(s => s.groupe).ToList();
                    var optionsList = new List<object>();
                    optionsList.Add("Add Student");
                    optionsList.AddRange(students1);
                    int choosen = (int)MenuV2(optionsList);
                    if (choosen == 0)
                    {
                        Window2.WriteLine("");
                    }
